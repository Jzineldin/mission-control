...
const CONTRACT_BODY = [
  ...
  '- Prefer GBrain MCP tools for shared-brain work: get_page, put_page, query, recall, sources_list, get_health.',
  '- Before relying on shared context, check get_health and sources_list when freshness or runtime health matters.',
  '- Treat think as provider-backed synthesis, not a baseline read tool: use it only after Mission Control shows the Think runtime as ready or GBrain has an active chat_model/models.think/provider proxy configured.',
